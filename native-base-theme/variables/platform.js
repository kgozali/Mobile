...
export default {
  ...
  // Segment
  segmentBackgroundColor: platform === "ios" ? "#c0333d" : "#c0333d",
  segmentActiveBackgroundColor: platform === "ios" ? "#fff" : "#fff",
  segmentTextColor: platform === "ios" ? "#fff" : "#fff",
  segmentActiveTextColor: platform === "ios" ? "#c0333d" : "#c0333d",
  segmentBorderColor: platform === "ios" ? "#fff" : "#fff",
  segmentBorderColorMain: platform === "ios" ? "#3F51B5" : "#3F51B5",
  ...
  titleFontSize: platform === "ios" ? 19 : 19,
